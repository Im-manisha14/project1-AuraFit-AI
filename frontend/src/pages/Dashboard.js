    ...
    return (
      <div className="flex items-center justify-center h-screen bg-gray-50 px-4">
        <div className="text-center">
          <div className="animate-spin rounded-full h-12 w-12 sm:h-16 sm:w-16 border-t-4 border-b-4 border-amber-600 mx-auto mb-4"></div>
          <p className="text-gray-700 font-medium text-sm sm:text-base">Loading your dashboard...</p>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="min-h-screen bg-white overflow-hidden">
      ...
      >
        <div className="container mx-auto px-3 sm:px-6">
          <motion.h2 
            ...
            viewport={{ once: true }}
            className="text-2xl sm:text-3xl font-bold text-center text-gray-900 mb-8 sm:mb-12 tracking-tight"
          >
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 sm:gap-8 max-w-4xl mx-auto">
            {[
              ...
              >
                <div className={`${item.color} h-20 sm:h-32 mb-2 sm:mb-4 shadow-md hover:scale-105 transition-transform`}></div>
                <p className="text-gray-900 font-medium text-sm sm:text-base">{item.name}</p>
              </motion.div>
            ))}
          </div>
        </div>
      ...
      <motion.div 
        ...
        viewport={{ once: true, margin: "-100px" }}
        transition={{ duration: 1 }}
        className="bg-gradient-to-br from-gray-900 via-gray-800 to-black text-white py-16 sm:py-24 relative overflow-hidden"
      >
        {/* Decorative background elements */}
        <div className="absolute top-0 right-0 w-48 h-48 sm:w-96 sm:h-96 bg-amber-600 opacity-5 rounded-full blur-3xl"></div>
        <div className="absolute bottom-0 left-0 w-48 h-48 sm:w-96 sm:h-96 bg-amber-600 opacity-5 rounded-full blur-3xl"></div>
        ...
        <div className="container mx-auto px-3 sm:px-6 relative z-10">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 lg:gap-20 items-center max-w-6xl mx-auto">
            ...
            >
              ...
              <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold mb-6 sm:mb-8 tracking-tight leading-tight">
                Luxurious & Distinctive
              </h2>
              
              <p className="text-gray-300 leading-relaxed mb-4 sm:mb-6 text-base sm:text-lg font-light">
              ...
              <p className="text-gray-300 leading-relaxed text-base sm:text-lg font-light mb-6 sm:mb-8">
            ...
            >
              {[
                ...
                <motion.div 
                  ...
                  className="bg-white bg-opacity-5 backdrop-blur-sm p-4 sm:p-8 text-center border border-white border-opacity-10 hover:border-amber-500 hover:border-opacity-50 transition-all duration-300 group"
                >
                  <motion.div
                    whileHover={{ rotate: 360 }}
                    transition={{ duration: 0.6 }}
                  >
                    <item.icon className="text-2xl sm:text-3xl lg:text-4xl text-amber-500 mx-auto mb-2 sm:mb-4 group-hover:text-amber-400 transition-colors" />
                  </motion.div>
                  <p className="text-white font-semibold text-sm sm:text-base mb-1 sm:mb-2">{item.label}</p>
